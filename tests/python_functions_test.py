...
class TestPythonFunctionPractice(unittest.TestCase):
    ...
    def test_volume_of_cube(self):
        volume_cube = calculate_volume_cube( 5 )
        self.assertEqual( 125, volume_cube )

    #Given a String, return the String reversed
    # @unittest.skip("delete this line to run the test")
    def test_reverse_string(self):
        string_reversed = get_string_reversed("For I was conscious that I knew practically nothing...")
        self.assertEqual("...gnihton yllacitcarp wenk I taht suoicsnoc saw I roF", string_reversed )

    #Given a value in farenheit, convert this into celsius.
    #@unittest.skip("delete this line to run the test")
    def test_fahrenheit_to_celsius(self):
        celsius_degrees = get_degrees_celsius( 98.6 )
        self.assertEqual( 37.0, celsius_degrees )
